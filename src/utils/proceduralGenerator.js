...
export function generateProceduralLevelPair(themeId = 'abstract_animated', targetDifficulty = 'Medium', seed = Date.now()) {
  ...
  // Draw (unused) to preserve the PRNG sequence for existing seeds; paint-style rendering
  // itself was superseded by the bespoke per-world drawing branches below.
  randomChoice(PAINT_STYLES);
