...
def run_fresh_10_batch():
    scenes = [
        {
            "id": "fresh_ai_confectionery_truffles_001",
        ...
        {
            "id": "fresh_ai_ceramic_mosaic_tiles_002",
        ...
        {
            "id": "fresh_ai_botanical_pressed_flora_003",
        ...
        {
            "id": "fresh_ai_glass_marbles_millefiori_004",
        ...
        {
            "id": "fresh_ai_succulents_greenhouse_grid_005",
        ...
        {
            "id": "fresh_ai_enamel_pins_collector_006",
        ...
        {
            "id": "fresh_ai_marine_seashells_specimens_007",
        ...
        {
            "id": "fresh_ai_stained_glass_jewels_008",
            "preferred_op": "recolor",
        ...
        {
            "id": "fresh_ai_heirloom_spices_botanical_009",
            "preferred_op": "recolor",
        ...
        {
            "id": "fresh_ai_wooden_toy_figurines_010",
