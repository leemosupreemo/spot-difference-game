    ...
    proposals = [
        {
            ...
            "desc": "Single screwdriver handle rubber grip tone calibrated in CIELAB (preserving 100% molded ridges & wear)",
            "hint": "Inspect the tool handles and grip sleeves near the center"
        },
        {
        ...
        {
            "id": "semantic_electronics_pcb_radial_cap_001",
            ...
            "base_image": "public/levels/semantic_electronics_pcb_radial_cap_001_base.jpg",
            "target_object": "Capacitor",
            "target_part": "Blue electrolytic sleeve",
            "target_bbox": [650, 320, 780, 450],
            "prompt_point": [715, 385],
            "difficulty": "Medium",
            "hue_direction_deg": 50.0,
            "desc": "Single radial capacitor sleeve tone shifted in CIELAB (preserving markings and lead solder)",
            "hint": "Scan the electrolytic capacitors near the upper circuit trace rail"
        },
        {
            "id": "semantic_electronics_inductor_coil_002",
            "title": "[Photo] Electronics PCB Copper Inductor Wrap",
            "source_url": "https://images.unsplash.com/photo-1518770660439-4636190af475?w=1600&auto=format&fit=crop&q=92",
            "base_image": "public/levels/semantic_electronics_inductor_coil_002_base.jpg",
            "target_object": "Inductor",
            "target_part": "Enamelled copper winding",
            "target_bbox": [780, 500, 900, 620],
            "prompt_point": [840, 560],
            "difficulty": "Medium",
            "hue_direction_deg": 40.0,
            "desc": "Single toroidal inductor copper winding tone shifted in CIELAB (preserving wire luster)",
            "hint": "Inspect the copper wire coils mounted on the circuit board"
        },
        {
            "id": "semantic_tailor_thread_spool_yellow_001",
            "title": "[Photo] Tailor Notions Box Gold Thread Spool",
            "source_url": "https://images.unsplash.com/photo-1520006403909-838d6b92c22e?w=1600&auto=format&fit=crop&q=92",
            "base_image": "public/levels/semantic_tailor_thread_spool_yellow_001_base.jpg",
            "target_object": "Thread Spool",
            "target_part": "Gold thread fibers",
            "target_bbox": [720, 380, 840, 500],
            "prompt_point": [780, 440],
            "difficulty": "Medium",
            "hue_direction_deg": 45.0,
            "desc": "Single gold thread spool fibers tone shifted in CIELAB (preserving wooden rim)",
            "hint": "Check the thread spools near the scissors"
        },
        {
            "id": "semantic_workshop_hex_wrench_handle_004",
            "title": "[Photo] Master Workbench T-Handle Hex Wrench",
            "source_url": "https://images.unsplash.com/photo-1581092160607-ee22621dd758?w=1600&auto=format&fit=crop&q=92",
            "base_image": "public/levels/semantic_workshop_hex_wrench_handle_004_base.jpg",
        ...
        },
        {
            ...
            "title": "[Photo] Gemologist Sorting Tray Ruby Setting",
        ...
        {
            "id": "semantic_workshop_bench_insulated_sleeve_005",
            "title": "[Photo] Master Workbench Insulated Plier Sleeve",
            "source_url": "https://images.unsplash.com/photo-1581092160607-ee22621dd758?w=1600&auto=format&fit=crop&q=92",
            "base_image": "public/levels/semantic_workshop_bench_insulated_sleeve_005_base.jpg",
            "target_object": "Pliers",
            "target_part": "Insulated sleeve grip",
            "target_bbox": [600, 360, 720, 470],
            "prompt_point": [660, 410],
            "difficulty": "Medium",
            "hue_direction_deg": 55.0,
            "desc": "Single plier handle insulation sleeve tone shifted in CIELAB (preserving molded ridges & wear)",
            "hint": "Scan the insulated plier handles near the center of the workbench"
        }
    ]
